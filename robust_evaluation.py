...
from models.HPFA import build_model
    ...
    for cur_r in missing_rate_list:
        ...
        if dataset_name == 'sims':
            ...
            if key_eval == 'Has0_acc_2':
                ...
                print(test_results_list[0]['Has0_acc_2'],'1')
                print(test_results_list[1]['Has0_acc_2'],'2')
                print(test_results_list[2]['Has0_acc_2'],'3')
                ...
                print(f'key_eval: {key_eval}, missing rate: {cur_r}, Mult_acc_5_avg: {Mult_acc_5_avg}')
                print(test_results_list[0]['Mult_acc_5'],'1')
                print(test_results_list[1]['Mult_acc_5'],'2')
                print(test_results_list[2]['Mult_acc_5'],'3')
                print((test_results_list[0]['Mult_acc_5']+test_results_list[1]['Mult_acc_5']+test_results_list[2]['Mult_acc_5'])/3,'4')
            elif key_eval == 'Mult_acc_7':
                Mult_acc_7_avg = (test_results_list[0]['Mult_acc_7'] + test_results_list[1]['Mult_acc_7']) / 2
